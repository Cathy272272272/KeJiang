...
public class third extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( dosth.kejiangList.contains(new kejiang("apple_pic", R.drawable.apple_pic)))
            Toast.makeText(this, "恭喜你与科酱成功牵手！", Toast.LENGTH_LONG).show();
        else Toast.makeText(this, "很遗憾，科酱已经灭灯了。", Toast.LENGTH_LONG).show();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerView.setAdapter(adapter);*/
                Intent intent = new Intent(third.this, end.class);
